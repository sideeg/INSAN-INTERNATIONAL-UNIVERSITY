...
@section('title', 'Graduation — INSAN International University')
...
<x-about-layout>
    ...
    <div class="mb-10">
        <h2 class="text-3xl font-bold text-gray-900 mb-3">Graduation & Convocation</h2>
        <p class="text-gray-500 max-w-2xl">
            Celebrating the achievements of our graduates — a milestone that marks the beginning of
            their contribution to society. Browse our convocation archive and upcoming ceremony details.
        </p>
    </div>
        ...
        <div class="flex flex-col md:flex-row">
            ...
            <div class="flex-1 p-8">
                ...
                <h3 class="text-2xl font-bold mb-2">
                    {{ $upcoming->ordinal ? $upcoming->ordinal . ' Convocation Ceremony' : $upcoming->title }}
                </h3>
    ...
    <h3 class="text-xl font-bold text-gray-800 mb-6">
        Convocation Archive
        <span class="text-sm font-normal text-gray-400 ml-2">({{ $archives->count() }} ceremonies)</span>
    </h3>

    @if ($archives->isEmpty())
        <div class="text-center py-20 text-gray-400">
            <div class="text-5xl mb-4">🎓</div>
            <p>No convocation records have been published yet.</p>
        </div>
    @else
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('about.graduation.show', $event->slug) }}"
               class="group block bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all">
                ...
                {{-- Details --}}
                <div class="p-5">
                    <p class="font-bold text-gray-800 group-hover:text-[#003366] transition-colors mb-1">
                        {{ $event->title }}
                    </p>
                    ...
                    <div class="flex gap-4 text-xs text-gray-500 border-t border-gray-100 pt-3">
                        ...
                        <span>🎓 {{ number_format($event->graduates_count) }} Graduates</span>
                        @endif
