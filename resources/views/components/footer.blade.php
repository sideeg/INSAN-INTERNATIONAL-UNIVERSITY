    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-2">
                <div class="flex items-center gap-3 mb-6">
                    <img src="{{ asset('images/insan_logo.jpg') }}" alt="INSAN Logo" class="h-16 w-auto">
                    <div>
                        <h3 class="font-serif text-white font-bold text-xl">INSAN</h3>
                        <p class="text-gray-400 text-xs tracking-wider">INTERNATIONAL UNIVERSITY</p>
                    </div>
                </div>
                    ...
                    @foreach($quickLinks as $link)
                        <li>
                            <a href="{{ isset($link['route']) ? route($link['route']) : $link['url'] }}" 
                               class="text-gray-400 hover:text-gold-500 text-sm transition-colors">
                                {{ $link['label'] }}
                            </a>
                        </li>
                    @endforeach
            ...
            <!-- Admissions -->
            <div>
                <h4 class="text-white font-bold mb-4">Admissions</h4>
                <ul class="space-y-3">
        ...
        <div class="mt-12 pt-8 border-t border-navy-700">
            ...
            <div class="mt-6 text-center text-gray-500 text-sm">
                {{ date('Y') }} {{ config('university.name', 'INSAN International University') }}. All Rights Reserved.
            </div>
        </div>
    </div>
</footer>